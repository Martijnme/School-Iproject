      ...
      <div class="row justify-content-center">
        ...
        <form action="../functions/registratie.php" method="POST" target="_self">
          ...
          <div class="row">
            <div class="col">
              <div class="form-group mb-3">
                <input type="email" name="email" class="form-control" placeholder="E-Mail*" aria-label="email" aria-describedby="basic-addon1" required>
              </div>
            </div>
            ...
            <div class="col">
              <div class="form-group mb-3">
                <input type="text" name="codemail" class="form-control" placeholder="Bevestigingscode*" required>
              </div>
            </div>
          </div>
          <input class="btn btn-primary" type="submit" value="Verstuurcode" />
          ...
          <div class="row">
            <div class="col">
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="gebruikersnaam" placeholder="Gebruikersnaam*" aria-label="gebruikersnaam" aria-describedby="basic-addon1" required>
              </div>
              <?php if ($error == "errorgebruikergevuld") {
                echo "<p style='color: #ff0f0f; font-size: 75%'>Vul een gebruikersnaam in. </p>";
              } ?>
            ...
            <div class="col">
              <div class="form-group mb-3">
                <input type="password" name="password" placeholder="Wachtwoord*" class="form-control" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col">
              <div class="form-group mb-3">
                <input type="text" name="voornaam" placeholder="Voornaam*" class="form-control" required>
              </div>
            </div>
            <div class="col">
              <div class="form-group mb-3">
            ...
            <div class="col">
              <input placeholder="Geboortedatum*" name="geboortedatum" type="text" onfocus="(this.type = 'date')" class="form-control mb-3" required>
              <?php if ($error == "errorgeboortedatum") {
          ...
          <div class="row">
            <div class="col">
              <div class="form-group mb-3">
                <input type="text" name="adresregel1" placeholder="Adresregel1*" class="form-control" required>
              </div>
            </div>
            <div class="col">
              <div class="form-group mb-3">
          ...
          <div class="col">
            <input type="text" name="land" placeholder="Land*" class="form-control mb-3" required>
          </div>
          ...
          <div class="row">
            <div class="col">
              <div class="form-group mb-3">
                <input type="text" name="tel1" placeholder="Telefoonnummer 1*" class="form-control" required>
              </div>
            </div>
            <div class="col">
              <div class="form-group mb-3">
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="form-group mb-3">
                <input type="text" name="vraag-antwoord" placeholder="Antwoord*" class="form-control" required>
              </div>
            </div>
          </div>
          ...
          <input type="submit" name="submit" value="Registreren" class="btn btn-primary mb-3 reg-button">
        </form>
